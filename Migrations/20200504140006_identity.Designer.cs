...
namespace SecondBike.Migrations
{
    ...
    [Migration("20200504140006_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecondBike.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SecondBike.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SecondBike.Data.Entities.Advertisement", b =>
                {
                    ...
                    b.HasOne("SecondBike.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
